...
Det betyder, at accelerationen er 2 meter per sekund per sekund (eller $2\frac{m}{s^2}$). Det er konstant, så cyklen øger sin hastighed med 2 meter per sekund for hvert sekund. (Hvis du synes, enheden for acceleration, $\frac{m}{s^2}$ er lidt forvirrende, så tjek @chap:enheder.)
