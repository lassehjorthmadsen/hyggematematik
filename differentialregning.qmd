...
## Hvordan finder vi tangentens hældning?
...
## Flere tangenter og deres hældninger
...
Det betyder, at accelerationen er 2 meter per sekund per sekund (eller $2 \text{m/s}^2$). Det er konstant, så cyklen øger sin hastighed med 2 meter per sekund for hvert sekund.
