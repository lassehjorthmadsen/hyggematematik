...
Det betyder, at potenstal og rødder kan være *alle* tal, og vi kan derfor også godt skrive $x^2,3$ eller $4^\pi$ eller $\sqrt[2.34]{x} = x^\frac{1}{2,34}$.
